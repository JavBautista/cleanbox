  ...
  <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" @click="abrirModal('customer','registrar')" class="btn btn-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                          <tr v-for="customer in arrayCustomers" :key="customer.id">
                              <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#" @click="abrirModal('customer','ver_datos', customer)">  <i class="fa fa-eye"></i>Ver</a></li>
                                    <li>
                                    <li>
                                      <a class="dropdown-item" href="#" @click="abrirModal('customer','actualizar_datos', customer)"><i class="fa fa-edit"></i>Editar</a>
                                    </li>
                                    <li>
                                        <a v-if="customer.active" class="dropdown-item" href="#" @click="actualizarAInactivo(customer.id)"><i class="fa fa fa-toggle-on"></i>Deshabilitar</a>
                                        <a v-else class="dropdown-item" href="#" @click="actualizarAActivo(customer.id)"><i class="fa fa fa-toggle-off"></i>Activar</a>
                                    </li>
                              ...
                              <td v-text="customer.company"></td>
                              <td v-text="customer.phone"></td>
                              <td v-text="customer.email"></td>

                              <td>
                                  <span v-if="customer.active" class="badge badge-success">Activo</span>
    ...
    export default {
        ...
        methods : {
            ...
            loadData(page,buscar,criterio,estatus){
                let me=this;
                var url = '/superadmin/customers/get?page='+page+'&buscar='+buscar+'&criterio='+criterio+'&estatus='+estatus;
            ...
            actualizarAActivo(id){
                ...
                swalWithBootstrapButtons.fire({
                  ...
                  if (result.value) {
                    ...
                    let me=this;
                    axios.put('/superadmin/customers/active',{
                        'id': id
            ...
            actualizarAInactivo(id){
                ...
                swalWithBootstrapButtons.fire({
                  ...
                  if (result.value) {
                    ...
                    let me=this;
                    axios.put('/superadmin/customers/deactive',{
                        'id': id
                    }).then(function (response){
                        me.loadData(me.pagination.current_page,me.buscar,me.criterio,me.estatus);
                        swalWithBootstrapButtons.fire(
            ...
            registrar(){
                ...
                let me=this;
                axios.post('/superadmin/customers/store',{
                    'name':me.name,
                    'alias':me.alias,
                    'company':me.company,
                    'rfc':me.rfc,
            ...
            actualizarDatos(){
                ...
                let me=this;
                axios.put('/superadmin/customers/update',{
                    'id':me.customer_id,
                    'name':me.name,
                    'alias':me.alias,
                    'company':me.company,
