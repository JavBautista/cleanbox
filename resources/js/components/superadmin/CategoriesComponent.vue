  ...
  <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" @click="abrirModal('category','registrar')" class="btn btn-primary">
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#" @click="abrirModal('category','ver_datos', category)">  <i class="fa fa-eye"></i>Ver</a></li>
                                    <li>
                                    <li>
                                      <a class="dropdown-item" href="#" @click="abrirModal('category','actualizar_datos', category)"><i class="fa fa-edit"></i>Editar</a>
                                    </li>
                                    <li>
                                        <a v-if="category.active" class="dropdown-item" href="#" @click="actualizarAInactivo(category.id)"><i class="fa fa fa-toggle-on"></i>Deshabilitar</a>
                                        <a v-else class="dropdown-item" href="#" @click="actualizarAActivo(category.id)"><i class="fa fa fa-toggle-off"></i>Activar</a>
                                    </li>
    ...
    export default {
        ...
        methods : {
            ...
            loadData(page,buscar,criterio,estatus){
                let me=this;
                var url = '/superadmin/categories/get?page='+page+'&buscar='+buscar+'&criterio='+criterio+'&estatus='+estatus;
                axios.get(url).then(function (response){
                    var respuesta  = response.data;
                    me.arrayCategories = respuesta.categories.data;
            ...
            actualizarAActivo(id){
                ...
                swalWithBootstrapButtons.fire({
                  ...
                  if (result.value) {
                    ...
                    let me=this;
                    axios.put('/superadmin/categories/active',{
                        'id': id
            ...
            actualizarAInactivo(id){
                ...
                swalWithBootstrapButtons.fire({
                  ...
                  if (result.value) {
                    ...
                    let me=this;
                    axios.put('/superadmin/categories/deactive',{
                        'id': id
                    }).then(function (response){
                        me.loadData(me.pagination.current_page,me.buscar,me.criterio,me.estatus);
                        swalWithBootstrapButtons.fire(
            ...
            registrar(){
                ...
                let me=this;
                axios.post('/superadmin/categories/store',{
                    'name':me.name,
            ...
            actualizarDatos(){
                ...
                let me=this;
                axios.put('/superadmin/categories/update',{
                    'id':me.category_id,
                    'name':me.name,
                    'description':me.description,
                }).then(function (response){
